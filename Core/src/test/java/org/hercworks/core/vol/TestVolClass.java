package org.hercworks.core.vol;
...
import org.hercworks.core.io.write.VolFileCompiler;
...
//			testVol = VolFileReader.parseVolFile("E:\\ES2_OS\\dev\\earthsiege2\\VOL\\BACKUP\\SHELL0.VOL");
			...
			for(VolEntry entry : testVol.getFilesSet()) {
				if(entry.getFileName().equals("TOMAHAWK.DAT")) {
					test = entry;
				}	
			}
			
			Voln compile = new Voln();
			compile.setFileName("SIMVOL1.VOL");
			
			compile.setFilePath("E:\\ES2_OS\\dev\\earthsiege2\\VOL");
			compile.setDbsimFlag(true);
			compile.setVshellFlag(false);
			...
			test.setMagicPrefix(Bytes.from(magic));
			test.getRawBytes()[4] = (byte)0xF4;
			test.getRawBytes()[5] = (byte)0x01;
//			
...
//			VolFileWriter.packVolToFileStrict(compile, "E:\\ES2_OS\\dev\\earthsiege2\\VOL");
	...
	public void testVolLoad() {
		...
		try {
			...
			testVol = VolFileReader.parseVolFile("E:\\ES2_OS\\dev\\earthsiege2\\VOL\\BACKUP\\SIMPATCH.vol");
